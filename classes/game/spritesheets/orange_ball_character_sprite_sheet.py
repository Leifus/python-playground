...
class OrangeBallCharacterSpriteSheet(SpriteSheet):
    def __init__(self, position):
        ...
        super( OrangeBallCharacterSpriteSheet, self).__init__(sprite_sheet_image_path, animation_data, current_animation, color_key, animate)
