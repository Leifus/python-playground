...
class PathTracer():
    ...
    def update(self, position_a, position_b):
        ...
        #     self.rect_a = pygame.draw.circle(self.surface, self.position_a_color, self.position_a, self.position_radius)
    ...
    def draw(self, surface: pygame.Surface):
        ...
        if self.position_b is not None:
            pygame.draw.circle(surface, self.position_b_color, self.position_b, self.position_radius)
            pygame.draw.line(surface, self.line_color, self.position_a, self.position_b, self.line_width)
